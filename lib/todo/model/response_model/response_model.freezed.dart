...
class _$ResponseModelTearOff {
  ...
  _ResponseModel call({List<TodoModel> responseList = const []}) {
...
mixin _$ResponseModel {
  List<TodoModel> get responseList => throw _privateConstructorUsedError;
...
abstract class $ResponseModelCopyWith<$Res> {
  ...
  $Res call({List<TodoModel> responseList});
}
...
class _$_ResponseModel with DiagnosticableTreeMixin implements _ResponseModel {
  const _$_ResponseModel({this.responseList = const []});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResponseModel(responseList: $responseList)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(responseList));
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel({List<TodoModel> responseList}) =
      _$_ResponseModel;
  ...
  @override
  List<TodoModel> get responseList;
  @override
  @JsonKey(ignore: true)
  _$ResponseModelCopyWith<_ResponseModel> get copyWith =>
      throw _privateConstructorUsedError;
